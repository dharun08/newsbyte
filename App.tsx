...
const SPORTS_KEYWORDS = [
  ...
  "stadium","venue","training","practice","referee","umpire"
];

const BUSINESS_KEYWORDS = [
  "market","markets","stocks","shares","sensex","nifty","dow","nasdaq",
  "earnings","profit","loss","revenue","growth","quarter","results",
  "ipo","listing","merger","acquisition","deal","investment","funding",
  "startup","valuation","bank","rbi","interest rate","inflation","gdp",
  "economy","economic","trade","exports","imports","company","corporate",
  "manufacturing","supply chain","sales","demand","forecast","outlook"
];

const TECH_KEYWORDS = [
  "ai","artificial intelligence","machine learning","chip","semiconductor",
  "software","hardware","app","platform","cloud","data","cybersecurity",
  "startup","saas","automation","robot","blockchain","web3","metaverse",
  "smartphone","mobile","laptop","device","gadget","update","launch"
];
...
const INDIA_KEYWORDS = [
  ...
  "rajasthan","telangana","andhra pradesh","odisha","punjab",
  "haryana","uttar pradesh","madhya pradesh","bihar","assam"
];
